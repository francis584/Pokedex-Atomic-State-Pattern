...
class HomeFixtures {
  ...
  static Map<String, dynamic> mockPokemonMap = {
    "abilities": [
      {
        "ability": {
          "name": "overgrow",
  ...
  static List<PokemonEntity> pokemonEntitiesList = List.generate(
      2, (index) => PokemonModel.fromMap(mockPokemonMap).toEntity());

  static Map<String, dynamic> jsonGetTypes = {
    "count": 20,
    "next": null,
    "previous": null,
    "results": [
  ...
  static List<TypeEntity> typeEntitiesList =
      List.generate(2, (index) => TypeEntity(name: 'fighting'));

  static Map<String, dynamic> jsonFightingPokemons = {
    "damage_relations": {
      "double_damage_from": [
        {"name": "flying", "url": "https://pokeapi.co/api/v2/type/3/"},
        {"name": "psychic", "url": "https://pokeapi.co/api/v2/type/14/"},
    ...
    "moves": [
      ...
      {"name": "axe-kick", "url": "https://pokeapi.co/api/v2/move/853/"},
      {
        ...
        "url": "https://pokeapi.co/api/v2/move/878/"
      },
