...
class DetailFixtures {
  static const jsonGetPokemonById = {
    "abilities": [
      {
        "ability": {
          "name": "overgrow",
  ...
  static const jsonGetPokemonSpeciesId = {
    "base_happiness": 50,
    "capture_rate": 45,
    "color": {
      "name": "green",
  ...
  static final pokemon = PokemonDetailsModel.fromMap(jsonGetPokemonById);

  static final pokemonSpecies =
      PokemonDetailsModel.fromMap(jsonGetPokemonSpeciesId);

  static PokemonDetailsEntity pokemonDetailsEntity = pokemon
      .copyWith(
